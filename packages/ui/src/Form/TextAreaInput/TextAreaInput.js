...
export const TextAreaInput = forwardRef(({ value, name, onChange, onFocus, autoFocus = false, onBlur, placeholder, hasError = false, size = 'small', disabled = false, rows = 2, isDefaultOutlineVisible = true, isShowingEllipsis = false, }) => {
